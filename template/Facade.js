...
module.exports = function(include, puremvc) {
  ...
  // include("Controller/StartCommand.js");
...
puremvc.define(
  ...
  },
  {
     ...
     */
    start: function() {
      console.log("{NAME_SPACE}.{CLASS_NAME} start");
      //this.registerCommand("START", {NAME_SPACE}.StartCommand);
  ...
  },
  {
    ...
    getInstance: function(multitonKey) {
      ...
      return instanceMap[multitonKey] = new {NAME_SPACE}.{CLASS_NAME}(multitonKey);
    },
